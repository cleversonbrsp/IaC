...
resource "oci_core_security_list" "private_subnet_sl" {
  ...
  egress_security_rules {
    ...
    destination      = "192.168.0.0/20" #virtual-nodes-private-node-subnet
  ...
  egress_security_rules {
    ...
    destination      = "192.168.16.0/20" #virtual-nodes-public-api-subnet-sl
    destination_type = "CIDR_BLOCK"
    protocol         = "6"
  ...
  ingress_security_rules {
    ...
    source      = "192.168.0.0/20" #virtual-nodes-private-node-subnet
  ...
  ingress_security_rules {
    stateless   = false
    description = "Path discovery"
    source      = "192.168.16.0/20" #virtual-nodes-public-api-subnet-sl
    source_type = "CIDR_BLOCK"
    protocol    = "1"
    icmp_options { #Path discovery
      type = 3
  ...
  ingress_security_rules {
    stateless   = false
    description = "Allow all traffic from CIDR 192.168.16.0/20"
    source      = "192.168.16.0/20" #Allow all traffic from CIDR 192.168.16.0/20
    source_type = "CIDR_BLOCK"
    protocol    = "6"
    tcp_options {
  ...
  ingress_security_rules {
    ...
    source      = "192.168.32.0/20" #virtual-nodes-service-lb-subnet - Load balancer
    source_type = "CIDR_BLOCK"
    protocol    = "6"
...
resource "oci_core_security_list" "public_subnet_sl" {
  ...
  egress_security_rules {
    ...
    destination      = "192.168.0.0/20" #virtual-nodes-private-node-subnet-sl
    destination_type = "CIDR_BLOCK"
  ...
  ingress_security_rules {
    ...
    source      = "192.168.0.0/20" #virtual-nodes-private-node-subnet-sl  
    source_type = "CIDR_BLOCK"
    protocol    = "6"
